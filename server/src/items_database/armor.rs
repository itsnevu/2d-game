...
pub fn get_armor_definitions() -> Vec<ItemDefinition> {
    vec![
        ...
        ItemBuilder::new("Reed Diver's Helm", "A breathing helmet made from hollow reeds sealed with tallow. Equip and press F while in sea or hot spring water to submerge. Lasts 45 minutes underwater. Frees hands for underwater combat.", ItemCategory::Armor)
