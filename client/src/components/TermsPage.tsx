            ...
            <div style={{
                ...
                <section style={{ marginBottom: '40px' }}>
                    ...
                    <p style={{
                        ...
                        All content, features, and functionality of the Game are owned by Wilder Team and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Game without our express written permission.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '40px' }}>
                    ...
                    <p style={{
                        ...
                        To the maximum extent permitted by law, Wilder Team shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of the Game. Our total liability shall not exceed the amount you paid for access to the Game, if any.
                    </p>
                </section>
