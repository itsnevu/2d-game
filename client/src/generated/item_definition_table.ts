...
export default __t.row({
  ...
  get alternativeCraftingCosts() {
    return __t.option(__t.array(__t.array(CostIngredient))).name("alternative_crafting_costs");
  },
  get flexibleIngredients() {
    return __t.option(__t.array(FlexibleIngredient)).name("flexible_ingredients");
  },
