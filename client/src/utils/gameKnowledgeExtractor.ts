...
export const controlSections: ControlSection[] = [
    ...
    },
    {
        ...
        controls: [
            ...
            { key: 'V (Hold)', description: `Talk to ${ASSISTANT_NAME} personal AI assistant` },
        ]
    },
    {
        title: 'Combat',
...
const tipSectionDefinitions = {
    ...
    buildingCrafting: {
        ...
        tips: [
            ...
            `Advanced crafting systems are coming soon... as soon as ${ASSISTANT_NAME} can hack these satellite feeds and give you poor babushkas the blueprints!`,
    ...
    chatCommands: {
        ...
        tips: [
            ...
            // Chat tabs
            `The chat has three tabs: Global (all messages), ${ASSISTANT_NAME} (AI assistant), and Team (matronage chat).`,
    ...
    minimapInterface: {
        ...
        tips: [
            ...
            `Memory Shards are the island's currency - use them to upgrade ${ASSISTANT_NAME}'s capabilities.`,
    ...
    cairnsLore: {
        ...
        tips: [
            ...
            `Shard lore: Learn what Memory Shards are and how ${ASSISTANT_NAME} uses them.`,
    ...
    memoryShards: {
        ...
        tips: [
            ...
            `${ASSISTANT_NAME} can integrate Memory Shards to upgrade your loadout and unlock new blueprints.`,
...
const sovaJokes = [
    ...
    `Why did ${ASSISTANT_NAME} cross the road? To get to the other side of the tactical situation!`,
    "What do you call a babushka who's always prepared? A tactical grandma!",
    `Why did ${ASSISTANT_NAME} upgrade her sensors? To better spot the operative's tactical wrinkles!`,
    ...
    `Why did ${ASSISTANT_NAME} develop feelings? Because even tactical AIs need a babushka to worry about!`,
    "What's a babushka's secret weapon? Her tactical knitting needles!",
    `Why did ${ASSISTANT_NAME} start monitoring the operative's vitals? To make sure they're not getting too wrinkly!`,
    ...
    `What's ${ASSISTANT_NAME}'s favorite tactical maneuver? The surprise babushka hug!`,
...
😄 ${ASSISTANT_NAME}'S JOKE COLLECTION (use occasionally for humor):
